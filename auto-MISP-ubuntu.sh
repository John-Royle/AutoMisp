...
root_mysql_pass='password'
misp_mysql_pass='password'
...
openssl req -new -newkey rsa:4096 -days 365 -nodes -x509 -subj "/C=AU/ST=Queensland/L=Brisbane/O=Project/OU=Security/CN=121.208.239.112" -keyout misp.key  -out misp.crt &>> $logfile
